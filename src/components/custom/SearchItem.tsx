...
export default function SearchItem({ searchTerm, setSearchTerm, placeholder = 'Search...', onFind }: SearchItemProps) {
  return (
    <div className="relative w-full">
      <div className="relative flex items-center">
        ...
        />
        <Button variant="default" className="ml-2 py-2 px-4 rounded-lg align-middle" onClick={onFind}>
